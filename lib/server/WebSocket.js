...
module.exports.WebSocket = klass(EventTarget, statics => {
    ...
    return {
        constructor: function(...args){
            ...
            sockets.get(this).readyState = module.exports.WebSocket.CONNECTING
            ...
            sockets.get(this).resolved_url = `${url.protocol}$//${url.hostname}:${url.port}`
            ...
            const onupgrade = (res, socket, head) => {
                ...
                sockets.get(this).readyState = module.exports.WebSocket.OPEN
                ...
                const onend = () => {
                    sockets.get(this).readyState = module.exports.WebSocket.CLOSED
