...
module.exports.View = klass(LibNode, statics => {
    ...
    return {
        constructor: function(...args){
            ...
            views.get(this).readystate = module.exports.View.BUSY
            ...
            views.get(this).zen.addEventListener("ready", e => this.dispatchEvent(e))
      ...
      , node: { enumerable: true,
            get: function(){
                ...
                return views.get(this).nodeproxy
            }
        }
      , nodes: { enumerable: true,
            get: function(){
                ...
                return views.get(this).nodesproxy
            }
        }
