...
//TODO : store indexes in a weakmap instead of iterating at event time
                        ...
                        if ( is_rule ) {
                            if ( updaters_text.has(rule) )
                              ...
                              while ( idx = stylesheets.get(this).rules.indexOf(rule), idx != -1 )
                                  stylesheets.get(this).rules[idx] = null,
                                  stylesheets.get(this).sheet.cssRules[idx].style.cssText = ""
